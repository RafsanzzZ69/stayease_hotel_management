...
const loadBookingData = async () => {
  try {
    const revenueRes = await axios.get("http://localhost:3000/api/admin/revenue");
    setRevenue(revenueRes.data);
  } catch (error) {
    toast({
      title: "Error",
      description: "Failed to load revenue stats",
      variant: "destructive",
    });
  } finally {
    setLoading(false);
...
const totalBookings = revenue.totalBookings || 0;
  ...
  const todaysCheckIns = revenue.todaysCheckins || 0;
  const totalRooms = revenue.totalRooms || 0;
